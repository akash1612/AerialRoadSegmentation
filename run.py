...
def run(args):
    ...
    if args.trained_model:
        model.load_state_dict(torch.load(args.output_path + 'params.pkl',torch.device('cpu')))
    # else:
    ...
    if args.test == True:
        ...
        for batch_idx, img in enumerate(test_loader):
            ...
            with torch.no_grad():
                ...
                merged_img.save(args.output_path + 'test_img'+str(batch_idx)+'.png')
                overlay.save(args.output_path + 'test_overlay'+str(batch_idx)+'.png')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size', type=int, default=1, help='Number of batch sizes')
